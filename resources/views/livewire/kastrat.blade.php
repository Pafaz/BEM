<div>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button type="button" id="createDataModalButton" data-modal-target="createDataModal"
                            data-modal-toggle="createDataModal"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-4">Judul</th>
                        ...
                        <tbody>
                            @foreach ($kastrats as $item)
                            <tr class="border-b dark:border-gray-700" wire:key="{{ $item->id }}">
                                <th scope="row"
                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{
                                    $item->judul }}</th>
                                <td class="px-4 py-3 text-blue-300">download</td>
                                <td class="px-4 py-3 max-w-[12rem] truncate">{{ $item->keterangan }}</td>
    ...
    <!-- End block -->
    <!-- Create modal -->
    <div id="createDataModal" tabindex="-1" aria-hidden="true" wire:ignore.self
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-modal-target="createDataModal" data-modal-toggle="createDataModal">
                ...
                <form wire:submit='store'>
                    <div class="flex flex-col">
                        <div>
                            ...
                            <input type="text" judul="judul" id="judul"
                                ...
                                placeholder="Type product judul" wire:model='judul'>
                            @error('judul')
                            <p class="text-red-500 py-2 px-2 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mt-4">
                            <label for="description"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Keterangan</label><textarea
                                id="description" rows="4"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Write product description here" wire:model='keterangan'></textarea>
                            @error('keterangan')
                            <p class="text-red-500 py-4 px-2 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            <livewire:dropzone wire:model="file" :rules="['mimes:pdf','max:10420','required']" />
                            @error('file')
                            <p class="text-red-500 py-4 px-2 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <form wire:submit='update'>
                    <div class="flex flex-col">
                        <div>
                            <label for="judul"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Judul</label>
                            <input type="text" judul="judul" id="judul" value="{{ $judul }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Ketik judul" wire:model='judul'>
                            @error('judul')
                            <p class="text-red-500 py-2 px-2 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
